...
import it.mcella.jcr.oak.upgrade.repository.firstversion.node.file.OakFileNode;
...
public class FilePersistenceTest {
    ...
    public void shouldCreateFileIntoParentFolderNode() throws Exception {
        ...
        filePersistence.createInto(parentFolderNode, FILE_NAME, HIDDEN, DELETABLE, image);

        verify(jcrParentNode).addNode(FILE_NAME, OakFileNode.NODE_TYPE);
        verify(jcrFileNode).setHidden(HIDDEN);
        verify(jcrFileNode).setDeletable(DELETABLE);
    ...
    public void shouldCreateFileIntoParentFolderNodeGivenParentFolderNodeId() throws Exception {
        ...
        filePersistence.createInto(jcrParentNodeId, FILE_NAME, HIDDEN, DELETABLE, image);
