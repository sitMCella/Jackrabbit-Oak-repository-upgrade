package it.mcella.jcr.oak.upgrade.apprun.firstversion;

import it.mcella.jcr.oak.upgrade.apprun.firstversion.action.Action;
import it.mcella.jcr.oak.upgrade.apprun.firstversion.action.ActionFactory;
import it.mcella.jcr.oak.upgrade.apprun.firstversion.action.ActionType;
import it.mcella.jcr.oak.upgrade.apprun.firstversion.action.InteractiveActionConsole;
